...
server.use(function(req, res, next) {
	...
	if(req.url.indexOf("swagger-ui") != -1 || lib.helper.validateKey(req.headers.hmacdata || '', req.params.api_key, lib)) {
		next()
	} else {
...
swagger.addModels(lib.schema)
swagger.setAppHandler(server)
lib.helper.setupRoutes(server, swagger, lib)
